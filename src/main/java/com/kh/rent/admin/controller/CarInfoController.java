...
//        }
	...
	//선택삭제
	@PostMapping("/deleteCheckedCar")
	@ResponseBody
	public String deleteCheckedCar(@RequestBody Map<String, Object> requestBody) {
		try {
			@SuppressWarnings("unchecked")
			List<Integer> carNumbers = (List<Integer>) requestBody.get("carNumbers");
			if (carNumbers != null) {
				log.info("carNumbers: " + carNumbers);

				int count = carInfoService.deleteCheckedCar(carNumbers);
