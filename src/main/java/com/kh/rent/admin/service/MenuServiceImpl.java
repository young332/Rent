...
public class MenuServiceImpl implements MenuService {
	...
	public List<MenuVO> getSubMenuAll(String menu_id) {
		List<MenuVO> subMenuList = menuMapper.getSubMenuAll(menu_id);
		return subMenuList;
	}
	...
	@Override
	public List<MenuVO> getSubMenuYN(String parent_menu_id) {
	    List<MenuVO> subMenuList = menuMapper.getSubMenuYN(parent_menu_id);
	    return subMenuList;
	}
