			...
			<div class="modal fade" id="modal-point-event" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form action="/customerevent" method="post" id="frmpoint">
							<input type="hidden" name="point_code" value="POINT_E">
							<input type="hidden" name="mem_id" id="point_mem_id" value="">
							<input type="hidden" name="mem_point" id="point_mem_point" value="">
