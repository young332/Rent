			...
			<form action="/admin/car/CarInfoAdd" method="post" enctype="multipart/form-data">
				...
				<div class="form-row">
					<div class="form-group col-md-6 mb-3">
						<label for="car_name" class="form-label">차량 이름</label> <input
							type="text" class="form-control" id="car_name" name="car_name"
							required>
					</div>
	
					<div class="form-group col-md-6 mb-3">
						<label for="car_number" class="form-label">차량 번호</label> <input
							type="text" class="form-control" id="car_number" name="car_number"
							required>
					</div>
				</div>
				...
				<div class="form-row">
					<div class="form-group col-md-6 mb-3">
						<label for="car_company" class="form-label">제조사</label> <input
							type="text" class="form-control" id="car_company" name="car_company">
					</div>
				...
				<div class="form-row">
					<div class="form-group col-md-3 mb-5">
						...
						<label class="custom-control custom-radio"> <input
							name="op_carseat" value="Y" type="radio"
					...
					<div class="form-group col-md-3 mb-5">
						<label>내비게이션</label>
						<label class="custom-control custom-radio"> <input
							name="op_navi" value="Y" type="radio"
							class="custom-control-input rdoY" checked> <span
							class="custom-control-label">사용</span>
						</label> 
						<label class="custom-control custom-radio"> <input
					...
					<div class="form-group col-md-3 mb-5">
						<label>후방 카메라</label>
						<label class="custom-control custom-radio"> <input
							name="op_cam" value="Y" type="radio"
							class="custom-control-input rdoY" checked> <span
							class="custom-control-label">사용</span>
						</label> 
						<label class="custom-control custom-radio"> <input
				...
				<div class="form-group mb-3">
					<label for="create_user" class="form-label">등록자</label><input
						type="text" class="form-control" id="create_user" name="create_user"
						required>
				</div>
