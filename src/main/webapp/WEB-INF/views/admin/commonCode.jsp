...
$(function(){
	...
	//하위코드 등록/수정
	$(document).on('click', '.btn-subModal', function() {
		console.log("버튼 클릭됨!");
        ...
        if(curMode == "Edit"){
	        ...
	        if(use_yn == "Y"){
	        	$('#SubCodeModal .rdoY').prop('checked', true);
	        	$('#SubCodeModal .rdoN').prop('checked', false);
	        }
	        if(use_yn == "N"){
	        	$('#SubCodeModal .rdoY').prop('checked', false);
	        	$('#SubCodeModal .rdoN').prop('checked', true);
	        }
	...
	$(".btnTopdelete").click(function() {
	    ...
	    $.ajax({
	        ...
	        success: function(data) {
	            ...
	            if (data.length == 0) {
	            	alert(parent_code+" 코드를 삭제하시겠습니까?");
						...
						<form action="/admin/commonCode/topCodeAdd" method="post">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control" placeholder="ex)Car" id="code_id" name="code_id" required>
									<div class="clearfix"></div>
								</div>
								<div class="form-group col-md-6">
									<label class="form-label">코드 이름</label>
									<input type="text" class="form-control" placeholder="코드 이름" name="code_name" id="code_name" required>
									<div class="clearfix"></div>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" placeholder="코드 순서" name="orderby" id="orderby" required>
									<div class="clearfix"></div>
								</div>
							</div>
							<div class="form-row">
								...
								<div class="row">
									...
									<div class="col-sm-10">
										<div class="custom-controls-stacked">
											<label class="custom-control custom-radio"> <input name="use_yn" value="Y" type="radio" class="custom-control-input rdoY" checked> <span class="custom-control-label">사용</span>
											</label> <label class="custom-control custom-radio"> <input name="use_yn" value="N" type="radio" class="custom-control-input rdoN"> <span class="custom-control-label">미사용</span>
											</label>
										</div>
									</div>
								</div>
					...
					<div class="modal-body">
						<form action="/admin/commonCode/subCodeAdd" method="post">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label class="form-label">code_id</label>
									<input type="text" class="form-control" placeholder="ex)Car_01" name="code_id" id="sub_code_id" required>
									<div class="clearfix"></div>
								</div>
								<div class="form-group col-md-6">
									<label class="form-label">코드 이름</label>
									<input type="text" class="form-control" placeholder="코드 이름" name="code_name" id="sub_code_name" required>
									<div class="clearfix"></div>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-12">
									<label class="form-label">코드 순서</label>
									<input type="text" class="form-control" placeholder="코드 순서" name="orderby" id="sub_orderby" required>
									<div class="clearfix"></div>
								</div>
							</div>
							<div class="form-row">
