	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 ftco-animate">
				...
				<form action="/reserve/licenseinfo" method="post">
					<div class="jumbotron card card-block"
						style="background-color: white;">
						<p>기본정보*</p>
						이름<input type="text" id="name" placeholder="이름을 입력해주세요."  value="${loginInfo.mem_name}" ><br>
						전화번호<input type="text" id="tel" placeholder="전화번호를 입력해주세요." value="${loginInfo.mem_phone}"><br>
						생년월일<input type="text" id="birthdate" placeholder="생년월일을 입력해주세요." value="${loginInfo.mem_birth}"><br>
						<br>
						<p>운전면허 정보</p>
