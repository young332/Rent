...
.fa-arrow-circle-right{
 ...
 .btn-secondary {
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('/resources/carbook-master/img/top1.jpg'); background-size: cover;" data-stellar-background-ratio="0.5">
